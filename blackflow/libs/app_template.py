...
class BfApplicationTemplate(BfApp):
    ...
    def on_message(self, topic, iot_msg):
        """
         ...
         """
        self.log.info("%s app was triggered by %s" % (self.name, topic))
        situation = iot_msg.get_default_value()
        self.log.info("Alarm situation %s"%situation)
